...
public class AcqEngMetadata {
   ...
   public static final String CORE_AUTOFOCUS_DEVICE = "Core-Autofocus";
   public static final String CORE_CAMERA = "Core-Camera";
   public static final String CORE_GALVO = "Core-Galvo";
   public static final String CORE_IMAGE_PROCESSOR = "Core-ImageProcessor";
   public static final String CORE_SLM = "Core-SLM";
   public static final String CORE_SHUTTER = "Core-Shutter";
   ...
   public static final String ZC_ORDER = "SlicesFirst"; // this is called ZCT in the functions
   ...
   public static final String EXPLORE_ACQUISITION = "ExploreAcquisition";
